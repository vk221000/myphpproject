		...
		<div id="sidebar">
            ...
            $productmenu=array('manageproducts.php', 'addproducts.php', 'editproducts.php', 'deleteproducts.php');
            $usermenu=array('addusers.php', 'editusers.php', 'deleteusers.php', 'manageusers.php');
            ?>
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
                    ...
                    <li><a <?php if ($filename=='manageproducts.php') :?>class='current' <?php endif;?> href="manageproducts.php">Manage Products</a></li> <!-- Add class "current" to sub menu items also -->
                        <li><a <?php if ($filename=='addproducts.php') :?>class='current' <?php endif;?> href="addproducts.php">Add Products</a></li>
						<li><a <?php if ($filename=='editproducts.php') :?>class='current' <?php endif;?> href="editproducts.php">Edit Products</a></li>
                ...
                <li> 
					...
					<ul>
						...
						<li><a <?php if ($filename=='addusers.php') :?> class='current' <?php endif; ?> href="addusers.php">Add users</a></li>
						<li><a <?php if ($filename=='editusers.php') :?> class='current' <?php endif; ?> href="editusers.php">Edit users</a></li>
